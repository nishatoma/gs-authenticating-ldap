...
Enter a user name of `ben` and a password of `benspassword`.

NOTE: You need to now add some properties in your `application.properties` file to
properly setup LDAP. Add the following lines to your `application.properties`:
